...
import { BookOpen, Code, Play, CheckCircle, ArrowRight, Star, Clock, Users } from 'lucide-react';
...
const Learn: React.FC = () => {
  ...
  const courses = {
    fundamentals: [
      {
        ...
        description: 'Learn the basic concepts of programming including variables, functions, and control structures.',
        duration: '2 hours',
        level: 'Beginner',
        students: '15.2K',
        rating: 4.8,
      ...
      },
      {
        ...
        description: 'Master OOP concepts like classes, inheritance, polymorphism, and encapsulation.',
        duration: '3 hours',
        level: 'Intermediate',
        students: '8.7K',
        rating: 4.9,
      ...
      },
      {
        ...
        description: 'Learn effective debugging strategies and tools to identify and fix code issues.',
        duration: '1.5 hours',
        level: 'Intermediate',
        students: '5.3K',
        rating: 4.7,
    ...
    python: [
      {
        title: 'Python Basics',
        description: 'Learn Python syntax, data structures, and fundamental programming concepts.',
        duration: '3 hours',
        level: 'Beginner',
        students: '19.8K',
        rating: 4.8,
      ...
      },
      {
        ...
        description: 'Explore data analysis, visualization, and machine learning with Python libraries.',
        duration: '8 hours',
        level: 'Intermediate',
        students: '14.2K',
        rating: 4.9,
    ...
    algorithms: [
      {
        ...
        description: 'Master essential data structures: arrays, linked lists, stacks, queues, and trees.',
        duration: '5 hours',
        level: 'Intermediate',
        students: '11.7K',
        rating: 4.8,
      ...
      },
      {
        ...
        students: '7.9K',
        rating: 4.9,
        topics: ['Recursion', 'Dynamic Programming', 'Greedy', 'Divide & Conquer']
      },
      {
        title: 'Big O Notation & Complexity',
        description: 'Understand time and space complexity analysis for efficient algorithm design.',
        duration: '2 hours',
        level: 'Intermediate',
        students: '13.4K',
        rating: 4.7,
        topics: ['Time Complexity', 'Space Complexity', 'Big O', 'Optimization']
      }
    ]
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Learn Programming</h1>
        <p className="text-gray-400">Master programming concepts with our comprehensive courses and interactive tutorials.</p>
      </div>
        ...
        <div className="lg:col-span-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {courses[selectedCategory as keyof typeof courses].map((course, index) => (
              <div key={index} className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden hover:border-purple-500 transition-colors duration-200">
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-xl font-semibold text-white">{course.title}</h3>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium text-white ${getLevelColor(course.level)}`}>
                      {course.level}
                    </span>
                  </div>
      ...
      <div className="mt-16">
        ...
        <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { step: 1, title: 'Fundamentals', description: 'Start with programming basics', icon: BookOpen },
              { step: 2, title: 'Choose Language', description: 'Pick JavaScript or Python', icon: Code },
              { step: 3, title: 'Build Projects', description: 'Apply your knowledge', icon: Play },
              { step: 4, title: 'Advanced Topics', description: 'Master algorithms & patterns', icon: Star }
            ].map((item, index) => (
